...
export default function MarketingPage() {
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="h-full flex flex-col items-center justify-center min-h-[60vh]">
      <div className="w-20 h-20 bg-pink-500/10 rounded-full flex items-center justify-center mb-6 shadow-[0_0_20px_rgba(236,72,153,0.2)] border border-pink-500/20">
        <Share2 size={32} className="text-pink-400" />
      </div>
      <h1 className="text-3xl font-bold text-white mb-2">Social Marketing Center</h1>
      <p className="text-gray-400 mb-8 max-w-md text-center">Automated AI content scheduling and cross-platform publishing systems are initializing.</p>
